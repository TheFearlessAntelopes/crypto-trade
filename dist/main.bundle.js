...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__home_home_module__ = __webpack_require__("../../../../../src/app/home/home.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__users_users_module__ = __webpack_require__("../../../../../src/app/users/users.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_user_service__ = __webpack_require__("../../../../../src/app/services/user.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_http__ = __webpack_require__("../../../http/@angular/http.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_http_requester_options_factory_service__ = __webpack_require__("../../../../../src/app/services/http-requester-options-factory.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_http_requester_service__ = __webpack_require__("../../../../../src/app/services/http-requester.service.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_8__angular_core__["M" /* NgModule */])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_1__users_users_module__["a" /* UsersModule */],
            __WEBPACK_IMPORTED_MODULE_7__angular_platform_browser__["a" /* BrowserModule */],
            __WEBPACK_IMPORTED_MODULE_13__angular_platform_browser_animations__["a" /* BrowserAnimationsModule */],
            __WEBPACK_IMPORTED_MODULE_14__angular_material__["d" /* MdSidenavModule */],
            __WEBPACK_IMPORTED_MODULE_14__angular_material__["e" /* MdToolbarModule */],
            __WEBPACK_IMPORTED_MODULE_14__angular_material__["a" /* MdButtonModule */],
            __WEBPACK_IMPORTED_MODULE_14__angular_material__["b" /* MdIconModule */],
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* RouterModule */].forRoot([
                { path: '', redirectTo: '/', pathMatch: 'full' },
            ])
        ],
        providers: [
            __WEBPACK_IMPORTED_MODULE_6__services_http_requester_service__["a" /* HttpRequesterService */],
            __WEBPACK_IMPORTED_MODULE_5__services_http_requester_options_factory_service__["a" /* HttpRequesterOptionsFactoryService */],
...
module.exports = "<md-toolbar id=\"footer\" color=\"primary\">\n  <span>Footer</span>\n  <md-icon class=\"example-icon\">favorite</md-icon>\n</md-toolbar>"
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HomeRouterModule; });
...
module.exports = "<h1>Welcome to the home page of our website</h1>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__home_component__ = __webpack_require__("../../../../../src/app/home/home.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__home_router_module__ = __webpack_require__("../../../../../src/app/home/home-router.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_common__ = __webpack_require__("../../../common/@angular/common.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
HomeModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["M" /* NgModule */])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__angular_common__["b" /* CommonModule */],
            __WEBPACK_IMPORTED_MODULE_1__home_router_module__["a" /* HomeRouterModule */]
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_0__home_component__["a" /* HomeComponent */]]
    })
], HomeModule);
...
/***/ "../../../../../src/app/services/http-requester-options-factory.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HttpRequesterOptionsFactoryService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var HttpRequesterOptionsFactoryService = (function () {
    ...
    HttpRequesterOptionsFactoryService.prototype.createRequestOptions = function (url, body, headers) {
        if (body === void 0) { body = {}; }
...
//# sourceMappingURL=http-requester-options-factory.service.js.map
...
var HttpRequesterService = (function () {
    function HttpRequesterService(httpService) {
        this.httpService = httpService;
    }
    HttpRequesterService.prototype.get = function (options) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */](options.headers);
    ...
    HttpRequesterService.prototype.put = function (options) {
        ...
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */](options.headers);
        return this.httpService.put(options.url, body, { headers: headers });
    };
    HttpRequesterService.prototype.post = function (options) {
        var body = JSON.stringify(options.body);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */](options.headers);
        return this.httpService.post(options.url, body, { headers: headers });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__http_requester_options_factory_service__ = __webpack_require__("../../../../../src/app/services/http-requester-options-factory.service.ts");
...
var UserService = (function () {
    function UserService(httpRequesterService, httpRequestOptionsFactory) {
        this.httpRequesterService = httpRequesterService;
        this.httpRequestOptionsFactory = httpRequestOptionsFactory;
        this.headersObj = { 'Content-Type': 'application/json' };
        this.registerUserUrl = '/auth/register';
        this.loginUserUrl = '/auth/login';
    }
    UserService.prototype.registerUser = function (user) {
        var httpRequestOptions = this.httpRequestOptionsFactory
...
module.exports = "<form class='example-form' #registerForm='ngForm' (ngSubmit)='onSubmit(ngForm)'>\n  <table class='example-full-width' cellspacing='0'>\n    <tr>\n      <td>\n        <md-input-container class='example-full-width'>\n          <input required mdInput placeholder='Username' name=\"username\" [(ngModel)]=\"user.username\">\n        </md-input-container>\n      </td>\n    </tr>\n    <tr>\n      <td>\n        <md-input-container class='example-full-width'>\n          <input required mdInput placeholder='First name' name=\"firstName\" [(ngModel)]=\"user.firstName\">\n        </md-input-container>\n      </td>\n    </tr>\n    <tr>\n      <td>\n        <md-input-container class='example-full-width'>\n          <input required mdInput placeholder='Last name' name=\"lastName\" [(ngModel)]=\"user.lastName\">\n        </md-input-container>\n      </td>\n    </tr>\n    <tr>\n      <td>\n        <md-input-container class='example-full-width'>\n          <input required mdInput placeholder='Password' type='password' name=\"password\" [(ngModel)]=\"user.password\">\n        </md-input-container>\n      </td>\n    </tr>\n    <tr>\n      <td>\n        <button md-raised-button type=\"submit\">Register</button>\n      </td>\n    </tr>\n  </table>\n</form>"
...
/***/ "../../../../../src/app/users/users-router.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UsersRouterModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
//# sourceMappingURL=users-router.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__register_register_component__ = __webpack_require__("../../../../../src/app/users/register/register.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__users_router_module__ = __webpack_require__("../../../../../src/app/users/users-router.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_common__ = __webpack_require__("../../../common/@angular/common.es5.js");
...
UsersModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["M" /* NgModule */])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__angular_common__["b" /* CommonModule */],
            __WEBPACK_IMPORTED_MODULE_1__users_router_module__["a" /* UsersRouterModule */],
